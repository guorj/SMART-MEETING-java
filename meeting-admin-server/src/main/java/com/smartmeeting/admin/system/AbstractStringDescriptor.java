...
abstract class AbstractStringDescriptor implements SystemConfigDescriptor {
    ...
    AbstractStringDescriptor(String key, String category, String defaultValue, String description) {
        this(key, category, defaultValue, description, null);
    }

    AbstractStringDescriptor(String key, String category, String defaultValue, String description, String parentKey) {
        this.key = key;
