...
- [ ] `MatterProgressReportService`：Docx 失败降级、AgentProvider 超时处理；补集成测试
...
- [ ] Agent 分支：`OPENCLAW_AGENT_PROVIDER`（llm/openclaw）、`OPENCLAW_COMP_BITABLE_PROGRESS`、综合管理会预设码
...
| OpenClaw Provider | `service/agent/OpenClawAgentProvider.java` |
